...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const menuItems = [
    ...
    { href: '/admin/proyectos', label: 'Proyectos', icon: Video },
    { href: '/admin/galeria', label: 'Galería', icon: ImageIcon },
    { href: '/admin/partituras', label: 'Partituras', icon: BookOpen },
    { href: '/admin/bio', label: 'Bio & Docs', icon: FileText },
  ];

  const currentMenu = menuItems.find(m => m.href === pathname) || menuItems[0];
